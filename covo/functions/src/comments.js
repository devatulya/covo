 ...
 *   onCommentDeleted → comments/{commentId} onDelete
 */
...
/**
 * When a comment document is deleted:
 * Decrement commentsCount on the referenced post (transactional, clamped to 0)
 */
