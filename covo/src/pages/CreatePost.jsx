...
import { ArrowLeft, BarChart2, ChevronDown, Image, Link2, Sparkles, X } from 'lucide-react';
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (imageFile) {
        ...
        if (!imageUrl) {
          throw new Error('Image upload failed before post creation.');
        }
      }
      ...
      alert(err.message || 'Failed to blast it. Check your connection or ImageKit config.');
    } finally {
      setUploading(false);
    }
  };
